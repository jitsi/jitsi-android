...
import org.jitsi.android.util.javax.swing.*;
               ...
               ScOtrKeyManagerListener
{
    ...
    {
        String actionCommand = null;//e.getActionCommand();
        ...
        else if (ACTION_COMMAND_CB_ENABLE.equals(actionCommand))
        {
            ...
            boolean state = false;//((JCheckBoxMenuItem) e.getSource()).isSelected();
        ...
        else if (ACTION_COMMAND_CB_REQUIRE.equals(actionCommand))
        {
            OtrPolicy policy =
                OtrActivator.scOtrEngine.getContactPolicy(contact);
            boolean state = true;//((JCheckBoxMenuItem) e.getSource()).isSelected();
    ...
    private void buildMenu()
    {
        ...
        //ndOtr.setActionCommand(ACTION_COMMAND_END_OTR);
