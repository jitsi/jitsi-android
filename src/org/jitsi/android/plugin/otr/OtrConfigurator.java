 ...
 * used. Can be seen as a proxy between the {@link org.jitsi.service.configuration.ConfigurationService} and the
 * OTR Plugin.
 *
...
public class OtrConfigurator
{
     ...
     * such property exists ({@link org.jitsi.service.configuration.ConfigurationService#getProperty(String)}
     * proxy).
     *
     ...
     * {@link org.jitsi.service.configuration.ConfigurationService#getBoolean(String, boolean)} proxy).
     *
     * @param id of the property that is being queried.
     ...
     * {@link org.jitsi.service.configuration.ConfigurationService#setProperty(String, Object)} proxy). The
    ...
    /**
     * Sets the property with the specified name to the specified value (
     * {@link org.jitsi.service.configuration.ConfigurationService#setProperty(String, Object)} proxy).
     *
     * @param id the name of the property to change.
     * @param value the new value of the specified property.
     */
     ...
     * {@link org.jitsi.service.configuration.ConfigurationService#removeProperty(String)} proxy).
     *
     * @param id the name of the property to change.
     */
