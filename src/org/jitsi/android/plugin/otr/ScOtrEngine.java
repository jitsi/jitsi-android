...
public interface ScOtrEngine
{
     ...
     *
     * @param contact the destination {@link net.java.sip.communicator.service.protocol.Contact}.
     ...
     *
     * @param contact the source {@link net.java.sip.communicator.service.protocol.Contact}.
     * @param content the original message content.
     * @return the transformed message content.
     */
    ...
    /**
     * Starts the Off-the-Record session for the given {@link net.java.sip.communicator.service.protocol.Contact}, if it's
     * not already started.
     *
     * @param contact the {@link net.java.sip.communicator.service.protocol.Contact} with whom we want to start an OTR
     *            session.
     */
    public abstract void startSession(Contact contact);

    /**
     * Ends the Off-the-Record session for the given {@link net.java.sip.communicator.service.protocol.Contact}, if it is
     * not already started.
     *
     * @param contact the {@link net.java.sip.communicator.service.protocol.Contact} with whom we want to end the OTR
     *            session.
     */
    public abstract void endSession(Contact contact);

    /**
     * Refreshes the Off-the-Record session for the given {@link net.java.sip.communicator.service.protocol.Contact}. If
     * the session does not exist, a new session is established.
     *
     * @param contact the {@link net.java.sip.communicator.service.protocol.Contact} with whom we want to refresh the OTR
     *            session.
     */
    public abstract void refreshSession(Contact contact);

    /**
     * Gets the {@link SessionStatus} for the given {@link net.java.sip.communicator.service.protocol.Contact}.
     *
     * @param contact the {@link net.java.sip.communicator.service.protocol.Contact} whose {@link SessionStatus} we are
     *            interested in.
    ...
    /**
     * Gets a {@link net.java.sip.communicator.service.protocol.Contact} specific policy.
     *
     * @param contact the {@link net.java.sip.communicator.service.protocol.Contact} whose policy we want.
     * @return The {@link net.java.sip.communicator.service.protocol.Contact} specific OTR policy. If the specified
     *         {@link net.java.sip.communicator.service.protocol.Contact} has no policy, the global policy is returned.
     */
     ...
     *
     * @param contact the {@link net.java.sip.communicator.service.protocol.Contact} whose policy we want to set
